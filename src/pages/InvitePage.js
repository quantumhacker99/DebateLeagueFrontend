...
const InvitePage = () => {
    ...
    const GetInviteDetails = async() => {
        ...
        const result = await Axios.get("http://localhost:3100/invite/" + state.invitationId.toString())
    ...
    const approveRequest = async() =>{
        const result = await Axios.post("http://localhost:3100/confirmInvite/" + inviteId.toString(), {
                                                        'approved':'true'
                                                    })
